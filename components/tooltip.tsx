  ...
  return (
    <>
      ...
      {tooltipData &&
        createPortal(
          <div
            className="bg-bg-primary text-text-secondary border-border-tertiary pointer-events-none fixed z-50 -translate-x-1/2 rounded border border-solid px-2.5 py-1.5 text-xs whitespace-nowrap shadow-xs"
            style={{
          ...
          >
            ...
            {/* 小三角形指示器 - 根据位置调整方向 */}
            <div
              className={`bg-bg-primary border-border-tertiary absolute left-1/2 h-3 w-3 -translate-x-1/2 rotate-45 border-solid ${
