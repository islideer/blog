        ...
        <div className="flex items-center gap-2">
          <Tooltip content="重新随机排序友链">
            <button
              ...
              className="text-text-secondary sm:hover:bg-bg-secondary sm:hover:text-text-primary active:bg-bg-secondary active:text-text-primary inline-flex items-center gap-1.5 rounded-md px-2.5 py-1.5 text-xs transition-all active:scale-80"
              aria-label="重新随机排序友链"
            >
