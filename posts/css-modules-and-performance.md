...
- 后处理器：[`PostCSS`](https://postcss.org/)，插件式，代表：[`autoprefix`](https://github.com/postcss/autoprefixer)
- `CSS Modules`，需要搭配 [`webpack`](https://webpack.js.org/)、[`Gulp`](https://gulpjs.com/) 或 [`Parcel`](https://parceljs.org/) 等构建工具
- `CSS in JS`，代表：基于 `React` 框架的 [`styled-component`](https://github.com/styled-components/styled-components)
