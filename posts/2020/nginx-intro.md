...
参考 👉[官方网站](http://www.nginx.cn/install)的安装教程。本文仅讨论 Nginx 在 Linux 服务器上的基本操作。Windows 系统下使用请参考 👉 [传送门](https://www.jb51.net/article/86839.htm)
...
- 保证内网安全：通常将反向代理作为公网访问地址，其他业务服务器是内网
...
`location` 后面用正则来匹配了所有以 API 结尾的请求，并将其转发到目的 URL `https://api.readhub.cn/` 上。
