  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center text-center">
      ...
      <div className="relative mb-6">
        <div className="text-text-secondary text-[100px] leading-none font-black opacity-24 sm:text-[140px] dark:opacity-36">
          500
        </div>
      ...
      {/* 描述文本 */}
      <p className="text-text-primary mb-4 text-sm sm:text-base">页面加载时遇到了一些问题</p>
      <p className="text-text-secondary mb-8 text-sm sm:text-sm">{error.message || '未知错误'}</p>

      {/* 操作按钮 */}
      <div className="flex flex-col items-center gap-3 text-sm sm:gap-4 sm:text-base">
        <button
          onClick={reset}
